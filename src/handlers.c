...
Response hello_handler(Request *request) {
	...
	return create_response("200 OK", "Content-Type: text/html",
						   "<!DOCTYPE html>"
						   "<html lang=\"en\">"
						   "<head><title>Hello Page</title></head>"
						   "<body><h1>Hello from C language!</h1><p>Welcome to "
						   "the Hello Page.</p></body>"
						   "</html>");
}

Response goodbye_handler(Request *request) {
	return create_response("200 OK", "Content-Type: text/plain",
						   "Goodbye, World!");
}
...
Response main_handler(Request *request) {
	return create_response(
		...
		"<p>C is the language of speed, power, and precision. It’s the "
		"foundation of modern computing, bringing systems to life with its "
		...
		"<footer>"
		"This website pays homage to the legendary C language—where every bit "
		"counts, and elegance meets power. Fun fact: the logic behind this "
		"site is also written in C!"
		"</footer>"
		"</body>"
		"</html>");
}
