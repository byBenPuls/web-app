...
Response handle_request(Router *router, Request *request) {
	...
	return create_response(
		...
		"css2?family=JetBrains+Mono:wght@400;700&display=swap\">"
		"</head>"
		"<body>"
		"<h1>404</h1>"
		"<p>The page you're looking for doesn't exist. But don't worry, the C "
		"language never forgets its roots!</p>"
		"<a href=\"/\" class=\"button\">Go Back Home</a>"
		"<footer>"
		"This 404 page is handcrafted with C, honoring the language that makes "
